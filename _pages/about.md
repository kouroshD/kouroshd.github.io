...
title: about
permalink: /
subtitle: Postdoctoral Researcher, University of Toronto <a href='https://web.cs.toronto.edu/'> <br>Computer Science</a>, <a href='https://vectorinstitute.ai/'> Vector Institute</a> 

profile:
  align: right
  image: kourosh_darvish_iit.jpg
  image_circular: false # crops the image to make it circular
  address: >
    <p>University of Toronto,</p>
    <p>6 King's College Road,</p>
    <p>M5S 3H5, Toronto, ON, Canada</p>
...
I am a postdoctorl researcher at the [Computer Science]() and [Robotics Institute]() at of [University of Toronto]() and a member of the [Vector Institute]().
I am doing research at [People, AI, & Robots (PAIR)]() lab directed by [Animesh Garg]()and [Robot Vision and Learning (RVL)]() lab directed by [Florian Shkurti]().
...
I received his B.Sc. and M.Sc. degrees in Aerospace Engineering from [K.N. Toosi University of Technology]() and [Sharif University of Technology](), Tehran, Iran.
Later, I earned PhD in Bioengineering & Robotics from the [University of Genoa](), Italy, where I developed novel techniques for human-robot collaboration. From Nov 2018- May 2022, I was a post-doctoral researcher at the Italian Institute of Technology (IIT) in the [Artificial and Mechanical Intelligence](https://ami.iit.it/) (previously named Dynamic Interaction Control) lab. During this period, I have collaborated on [AnDy](https://andy-project.eu/) and [SoftManBot](http://softmanbot.eu/) H2020 European projects, Italian National [ergoCub project](https://ami.iit.it/projects), and international ANA Avatar XPRIZE $10M competition. At IIT, I have worked on human motion perception and prediction, humanoid robot teleoperation, and safety and ergonomics enhancement in human-robot collaboration.
...
<!-- I am Kourosh Darvish. Write your biography here. Tell the world about yourself. Link to your favorite [subreddit](http://reddit.com). You can put a picture in, too. The code is already in, just name your picture `prof_pic.jpg` and put it in the `img/` folder.
